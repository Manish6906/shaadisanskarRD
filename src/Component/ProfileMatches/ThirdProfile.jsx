...
import profile2 from "../../assets/Images/Rectangle 192 (1).png"
...
import image11 from "../../assets/Images/Group 215 (2).png";
...
const ThirdProfile = () => {
  ...
  <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-13 h-13 border-2 border-[#FF5A60] rounded-full flex items-center justify-center bg-[#FCD0B2]">
        <FontAwesomeIcon icon={faChild} className="text-[#FF5A60] text-2xl z-10" />
    ...
    <div className="w-full sm:w-2/3">
      ...
      <div className="flex gap-3 mb-2 flex-wrap">
        {["Photography", "Acting", "Dancing"].map((item) => (
          <span key={item} className="bg-[#FF5A60] text-white px-4 py-1 rounded-full text-sm font-medium">
            {item}
          </span>
        ))}
      </div>
  ...
  {/* Lifestyle */}
  <div className="flex flex-col sm:flex-row items-start mt-5 gap-2 mb-7">
    {/* Icon and line */}
    <div className="flex flex-col items-center">
      <div className="relative w-13 h-13 border-2 border-[#FF5A60] rounded-full flex items-center justify-center bg-[#FCD0B2]">
    ...
    {/* Title and chips */}
    <div className="w-full sm:w-2/3">
      <h3 className="text-2xl font-normal text-[#000000] mb-6">Lifestyle</h3>
      <div className="relative flex mt-24 justify-start">
        <img src={images1} alt="veg" className="bg-amber-50 rounded-full w-8" />
  ...
  <div className="flex flex-col sm:flex-row items-start gap-2 mb-7">
    ...
    {/* Title */}
    <div className="w-full sm:w-2/3">
      <h3 className="text-2xl font-normal text-[#000000] mb-6">Background</h3>
      <div className="space-y-2">
        <p className="text-[#000000]">Sikh, Punjabi</p>
        <p className="text-[#000000]">Arora</p>
        <p className="text-[#000000]">Lives in Chandigarh, Punjab, India</p>
      </div>
    </div>
  </div>
  ...
  <div className="flex flex-col sm:flex-row items-start gap-4 mb-7">
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-13 h-13 border-2 border-[#FF5A60] rounded-full flex items-center justify-center bg-[#FCD0B2]">
        <img src={images3} alt="family" />
      </div>
      <div className="w-px h-47 bg-[#FF5A60]" />
    </div>

    <div className="w-full sm:w-2/3">
      <h3 className="text-2xl font-normal text-[#000000] mb-4">Family Details</h3>
      <div className="space-y-2">
        <p className="text-[#000000]">Father has passed away, Mother is a homemaker</p>
        ...
        <p className="text-[#000000]">Middle - Annual family income is 10-30 lakhs</p>
  ...
  <div className="flex flex-col sm:flex-row items-start gap-4 mb-7">
    ...
    <div className="w-full sm:w-2/3">
      <h3 className="text-2xl font-normal text-[#000000] mb-4">Education & Career</h3>
      <div className="space-y-2">
        <p className="text-[#000000]">Customer Support / BPO / KPO Professional</p>
        <p className="text-[#000000]"><span className="font-bold">Self:</span> Earns Upto INR 1 Lakh annually</p>
        <p className="text-[#000000]"><span className="font-bold">Family:</span> Earns INR 10-30 lakhs annually</p>
      </div>
    </div>
  </div>
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="bg-peach-100 p-6 rounded-lg max-w-4xl mx-auto text-[#FF5A60]">
        ...
        <div className="grid grid-cols-2  justify-between gap-4 mt-6 text-sm">
          ...
          <div className="flex flex-col  items-end space-y-8 gap-4 md:space-y-6 ">
