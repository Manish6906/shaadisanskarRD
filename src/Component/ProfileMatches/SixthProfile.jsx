...
import profile3 from "../../assets/Images/Rectangle 192 (4).png"
...
import image10 from "../../assets/Images/Group 214.png";
import image11 from "../../assets/Images/Group 215.png"
  ...
  return (
    <div className="jost">
      ...
      <div className="max-w-2xl mx-auto p-4 bg-[#FFCCA8] rounded-xl shadow-md text-[#5A1D0D]">
        ...
        <div className="flex items-start mt-7 space-x-2 mb-7">
          {/* Icon and line */}
          <div className="flex flex-col items-center">
            <div className="relative w-13 h-13 border-2 border-[#FF5A60] rounded-full flex items-center justify-center bg-[#FCD0B2]">
      ...
      <div className="mt-5 flex justify-center pb-2">
              <button className="bg-[#FF5A60] hover:bg-[#ff3b5f] text-white font-medium py-1 px-2  md:px-4 md:py-2 rounded-full">
                Back to top
              </button>
              </div>
    </div>
